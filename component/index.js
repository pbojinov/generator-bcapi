...
ComponentGenerator.prototype.writeIndex = function writeIndex() {
    // this.indexFile = this.engine((this.read('component-template.html')), this);
    var indexPath = this.sourceRoot() + '/component-template.html',
        jsPath = this.sourceRoot() + '/component-script.js',
        cssPath = this.sourceRoot() + '/component-styles.css';
