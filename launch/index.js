...
var LaunchGenerator = module.exports = function ComponentLaunchGenerator(args, options, config) {
...
util.inherits(LaunchGenerator, yeoman.generators.NamedBase);

LaunchGenerator.prototype.askFor = function askFor() {
    var cb = this.async();
    ...
    var prompts = [
        {
            name: 'gadgetName',
            message: 'What is the name of the gadget that you will be launching?',
            default: 'gadget'
        },
        {
            type: 'confirm',
...
LaunchGenerator.prototype.writeIndex = function writeIndex() {
    // this.indexFile = this.engine((this.read('component-template.html')), this);
    var indexPath = this.sourceRoot() + '/launch-template.html',
        jsPath = this.sourceRoot() + '/launch-script.js',
        cssPath = this.sourceRoot() + '/launch-styles.css';
...
LaunchGenerator.prototype.files = function files() {
